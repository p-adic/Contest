...
TE <int NUM> uint COantsForDMods<NUM>::g_M = P;TE <int NUM> uint COantsForDMods<NUM>::g_memory_le = 0;TE <int NUM> uint COantsForDMods<NUM>::g_M_minus = P-1;TE <int NUM> bool COantsForDMods<NUM>::g_M_is_prime = true;
